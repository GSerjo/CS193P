...
final class RecentsTableViewController: UITableViewController {
    
    let _recents = RecentSearches()
    
    private struct Constants {
        static let CellReuseIdentifier = "Recents"
        static let SegueIndentifier = "ShowRecentSearch"
    }
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return _recents.searches.count
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = _recents.searches[indexPath.row]
        return cell
    }
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if let identifier = segue.identifier {
            if identifier == Constants.SegueIndentifier {
